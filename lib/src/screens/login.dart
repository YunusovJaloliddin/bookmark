  ...
  Widget build(BuildContext context) {
    return TextField(
      ...
      decoration: InputDecoration(
        ...
        suffixIcon: widget.suffixicon != null ? IconButton(onPressed: (){setState(() {check=!check;});}, icon: Icon(check?Icons.visibility:Icons.visibility_off,)) : null,
